...
PV_Install_Capacity = [500,600] # kW1350
PVSyst_Energy_per_year_per_kWp = [1265,1265] # (PVSyst kWh/year/kWp) or https://globalsolaratlas.info/ tracking +20%
PVSyst_GlobInc = 1734.9 # (PVSyst: GlobInc kWh/m2/year)
