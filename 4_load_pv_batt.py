...
PV_Install_Capacity = [1,50,100,150] # kW
...
def cal_pv_serve_load(df_pv,df_load,pv_install_capacity):
    ...
    print(f"  -- suggest Battery Saving  : {(sum_batt_store_kWh*4):.0f} THB  ({(sum_batt_store_kWh*10*4/batt_cap_selected):.0f} THB/kWh/10years)")
